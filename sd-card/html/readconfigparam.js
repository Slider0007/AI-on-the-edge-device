...
function ParseConfig() {
     ...
     ParamAddSingleValueWithPreset(param, catname, "TLSCACert", true, "/config/certs/mqtt_ca.crt");
     ParamAddSingleValueWithPreset(param, catname, "TLSClientCert", true, "/config/certs/mqtt_client.crt");
     ParamAddSingleValueWithPreset(param, catname, "TLSClientKey", true, "/config/certs/mqtt_client.key");
