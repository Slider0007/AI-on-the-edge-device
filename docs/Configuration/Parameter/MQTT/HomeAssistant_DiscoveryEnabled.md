...
Refer to MQTT API - Home Assistant description for more details about Home Assistant discovery topics.
...
!!! Note
    ...
    - This request can also be triggered by `WebUI > Manual Control > Resend HA Discovery`.<br>
