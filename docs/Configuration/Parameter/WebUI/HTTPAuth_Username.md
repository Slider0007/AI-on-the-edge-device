...
| Default Value     | `aiote`             | `aiote`


## Description

Username for WebUI / REST API endpoint authentication.
...
!!! Warning
    ...
    not encyrpted or hashed) across the physical network used as the carrier. All data 
