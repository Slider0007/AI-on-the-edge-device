# Firmware Installation (NULLLAB ESP32-S3-CAM / Other SOC & pin-compatible variants)
...
#### Procedure
  1. **Enter bootloader mode**: Keep 'BOOT' button pushed (IO0 pulled to GND) while reseting the board
