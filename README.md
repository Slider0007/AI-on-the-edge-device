...
| [ESP32-S3-CAM (AI-THINKER)](images/boards/esp32s3-cam.png) | ESP32S3-WROOM-1-N16R8 | 1. WiFi Client<br>2. WiFi AP | ✅ Onboard LED<br>→ Pin: GPIO48 (SmartLED) | ≥ v17.4.0 | `freenove-esp32s3-n16r8` | ℹ️ Board is pin-compatible and identified as `freenove-esp32s3-n16r8` |
| [ESP32-S3-CAM (NULLLAB)](images/boards/esp32s3-cam-nulllab.jpg) | ESP32S3-WROOM-1-N8R8 | 1. WiFi Client<br>2. WiFi AP | ✅ Onboard LED<br>→ Pin: GPIO3 (PWM) | ≥ v18.0.0 | `nulllab-esp32s3cam` |  |
...
Some generic documentation can be found in [documentation repository](https://jomjol.github.io/AI-on-the-edge-device-docs/) of upstream project.Upstream documentation may not reflect all features or modifications present in this fork. For repository-specific guides, check the [docs](/docs/) folder.
