...
| [OV5640](https://cdn.sparkfun.com/datasheets/Sensors/LightImaging/OV5640_datasheet.pdf) | 5MP                | 1.0x - 4.0x  | $\ge$ v17.0.0    |ℹ️ Power consumption higher than OV2640<br>⚠️ Running quite hot, a small heat sink is recommended to get stable image quality<br>⚠️ ESP32-CAM: Functional. Core and I/O voltage supply out of specification (board: 1.2V / 3.3V, camera: 1.5V / 2.8V).<br>⚠️ XIAO ESP32S3 Sense: Functional. Core supply out of specification (board: 1.3V, camera: 1.5V).
